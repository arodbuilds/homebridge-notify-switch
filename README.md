...
3. **Fees.** As of September 2026, Sole Proprietor registration costs $4 once for the brand, $15 once for campaign vetting, and $2 per month per campaign, per Twilio's [Sole Proprietor Brands FAQ](https://support.twilio.com/hc/en-us/articles/9550596959643-A2P-10DLC-Sole-Proprietor-Brands-FAQ). Twilio's per-message price and the carrier surcharges are on [Twilio's US SMS pricing page](https://www.twilio.com/en-us/sms/pricing/us), and nothing else in this document repeats them.
